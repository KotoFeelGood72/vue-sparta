			...
			<div class="box white">
				<div class="content-box-item">
					...
					<div class="notice">
						...
						<span>Наша компания гарантирует, что введенные вами контактные данные не будут использованы для рассылки нежелательной корреспонденции или переданы третьим лицам.</span>
					</div>

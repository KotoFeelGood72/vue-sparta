 ...
 * version 2.4
 */
function spart_breadcrumbs( $sep = '', $l10n = array(), $args = array() ){
  ...
  if(1){
    ...
    if( $mrk == 'rdf.data-vocabulary.org' ){
      $mrk = array(
        'wrap'       => '<div class="breadcrumbs" prefix="v: http://rdf.data-vocabulary.org/#">',
        'wrap_close' => '</div>',
    ...
    elseif( $mrk == 'schema.org' ){
      $mrk = array(
        'wrap'       => '<div class="breadcrumbs" itemscope itemtype="http://schema.org/BreadcrumbList">',
        'wrap_close' => '</div>',

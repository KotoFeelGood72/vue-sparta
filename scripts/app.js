...
$(document).ready( function() {
	...
	// });
	//
	// $(".button_zakaz_spec").click(function() {
	// 	$("#form-query_z").submit();
	// });
	//
	// $("#form-query_z").submit( function() {
	// 	//alert("sss");
	...
	// 	data: formNm.serialize(),
	// 	beforeSend: function () {
	// 		$(".button_zakaz_spec", formNm).html("<span>Оправка заказа...</span>");
	// 	},
	// 	success: function () {
	// 		$("input", formNm).prop( "disabled", true );
	// 		$("textarea", formNm).prop( "disabled", true );
	// 		$(".button_zakaz_spec", formNm).html("Заказ принят");
	// 		$(".button_zakaz_spec").attr('disabled','disabled');
	// 		//$.modal.close();
	// 	},
	// 	error: function () {
	// 		alert( "Возникла ошибка при отправке запроса. Попробуйте еще раз." );
	// 		$(".button_zakaz_spec", formNm).html("<span>Заказать спецзапчасти</span>");
	// 	}
	// 	});
	// 	return false;
	// });
